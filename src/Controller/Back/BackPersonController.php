 ...
 * @Route("/back/person")
 */
class BackPersonController extends AbstractController
{
    /**
     * @Route("/index", name="app_back_person_index", methods={"GET"})
     */
    public function index(PersonRepository $personRepository): Response
    {
        return $this->render('back/back_person/index.html.twig', [
    ...
    public function new(Request $request, PersonRepository $personRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_back_person_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('back/back_person/new.html.twig', [
            'person' => $person,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/back_person/show.html.twig', [
            'person' => $person,
        ]);
    }
    ...
    public function edit(Request $request, Person $person, PersonRepository $personRepository): Response
    {
        ...
        return $this->renderForm('back/back_person/edit.html.twig', [
            'person' => $person,
            'form' => $form,
        ]);
    }
